...
<?php 
    // $_SESSSION['status'] = 1;
    // $_SESSSION['IS_REGISTERED'] = true;
    // include 'page_block.php';
?>
    ...
    if(isset($_POST["verify"])){
        ...
        if($otp != $otp_code){
           ...
           <?php
            ...
            ?>
             <script>
                //redirecting to PHP to control NodeMCU
                alert("Verfiy OTP done");
                
                window.location.replace("../Control/control.php");
             </script>
             <?php
        }
